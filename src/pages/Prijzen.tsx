...
const Prijzen = () => {
  ...
  return (
    <Layout>
      <PageHeader
        label="Prijzen"
        title="Professionele websites" titleMuted="vanaf €495" titleMutedClassName="text-[hsl(var(--accent-orange-soft))]"
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            >
              ...
              <AccordionContent className="pb-6 px-6 text-[0.9375rem] text-foreground/85 leading-relaxed">
                ...
                <div className="mt-6 pt-6 border-t border-border/60 flex flex-col items-start sm:flex-row sm:items-center gap-4 bg-foreground rounded-xl p-5">
                  <img
